...
export const Education: React.ComponentType = () => (
  <Section title="Education">
    <LocationBlock title="University of Technology Sydney" url="https://www.uts.edu.au">
      <ExperienceBlock
        title="Bachelor of Science in Information Technology & Bachelor of Arts in International Studies"
      ...
      >
        ...
        <p>
          <strong>Electives</strong> - Software Development Project, iOS Development, Android Development, Cloud
          Computing SaaS, Webmedia, Mobile Networking.
        </p>
      </ExperienceBlock>
    </LocationBlock>
    <LocationBlock title="Kagoshima University" url="https://www.kagoshima-u.ac.jp">
      <ExperienceBlock title="In-country study exchange" startDate="April 2014" endDate="February 2015">
        <p>
